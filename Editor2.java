...
public class Editor2 {
	...
	public static void main (String[] args){
		...
		Color[][] imageFromFile = Runigram.read(fileName);
		Color[][] newImage = Runigram.scaled(imageFromFile, width, height);

		Runigram.setCanvas(imageFromFile);
        Runigram.display(imageFromFile);
        StdDraw.pause(3000); 
